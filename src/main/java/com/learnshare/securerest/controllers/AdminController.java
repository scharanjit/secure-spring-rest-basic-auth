...
public class AdminController {
    ...
    @RequestMapping(value = "/persistHL7", method = RequestMethod.POST, produces = "text/plain", consumes = "application/json")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK"),
            @ApiResponse(code = 401, message = "You are not authorized access the resource"),
            @ApiResponse(code = 404, message = "The resource not found")
    ...
    @ResponseBody
    public ResponseEntity<String> persistHL7(@RequestBody String name) throws InterruptedException {
        logger.info("Post request received succesfully ... !!");
